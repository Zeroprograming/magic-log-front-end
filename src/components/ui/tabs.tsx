...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-start border-b-2 p-1 text-muted-foreground w-full',
      className,
    )}
    {...props}
  />
